        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="sidebar mb-5">
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            <h3 class="card-title fs-18 pb-2">Cours Categories</h3>
                            <div class="divider"><span></span></div>
                            ...
                            <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1">
                                <div class="card-image">
                                    <a href="{{url('course/details/'.$courses->id.'/'.$courses->course_name_slug)}}" class="d-block">
                                        <img class="card-img-top lazy" src="{{asset($courses->course_image)}}" data-src="images/img8.jpg" alt="Card image cap">
                                    </a>
