                           ...
                           <div class="media media-card">
                               <div class="instructor-img">
                                   <a href="teacher-detail.html" class="media-img d-block">
                                       <img class="lazy" src="{{ !empty($course->user->photo) ? url('upload/instructor_profile/' . $course->user->photo) : url('upload/no-image.png') }}" alt="Avatar image">
                                   </a>
                                   <ul class="generic-list-item pt-3">
                                       ...
                                       <li><i class="la la-play-circle-o mr-2 text-color-3"></i> {{count($instructorCourse)}} Courses</li>
