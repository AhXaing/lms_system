            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Instructor Change Password</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
        ...
        <div class="container">
            <div class="main-body">
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ !empty($profileData->photo) ? url('upload/instructor_profile/' . $profileData->photo) : url('upload/no-image.png') }}"
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <form action="{{ route('instructor.update-password-instructor') }}" method="POST"
