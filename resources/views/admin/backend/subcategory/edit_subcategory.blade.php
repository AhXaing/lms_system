            ...
            <div class="col-xl-6 mx-auto">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <form action="{{ route('update-subcategory') }}" id="frmCategory" class="row g-3" method="POST"
                                    ...
                                    <select name="category_id" id="category_id" class="form-select mb-3"
                                        ...
                                        @foreach ($category as $cate)
                                            <option value="{{ $cate->id }}"
                                                {{ $cate->id == $subcategory->category_id ? 'selected' : '' }}>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <div class="position-relative input-icon">
                                    <input type="text" class="form-control" name="subcategory_name" id="subcategory_name"
                                        value="{{ $subcategory->subcategory_name }}" placeholder="Subcategory Name">
