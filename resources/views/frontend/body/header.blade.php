                                ...
                                <ul>
                                    <li>
                                        ...
                                        <ul class="cat-dropdown-menu">
                                            ...
                                            @php
                                                $subCategories = App\Models\SubCategory::where('category_id',$cate->id)->orderBy('subcategory_name','ASC')->get();
                                            @endphp
                                                <li>
                                                    <a href="{{ url('category/'.$cate->id.'/'.$cate->category_slug)}}">{{$cate->category_name}} <i
                                                            class="la la-angle-right"></i></a>
                                                    <ul class="sub-menu">
                                                        @foreach ($subCategories as $subCate)
                                                            <li><a href="{{ url('subcategory/'.$subCate->id.'/'.$subCate->subcategory_slug)}}">{{$subCate->subcategory_name}}</a></li>
                                                        @endforeach
