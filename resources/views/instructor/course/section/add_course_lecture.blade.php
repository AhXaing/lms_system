    ...
    <script>
        function addLectureDiv(courseId, sectionId, containerId) {
            ...
            newLectureDiv.innerHTML = `
                <div class="container-flud m-5 mt-0 mb-0">
                    <h6>Lecture Title</h6>
                    <input type="text" class="form-control" placeholder="Enter Lecture" />
                    <textarea name="" id="" rows="3" class="form-control mt-2" placeholder="Enter Lecture Content"></textarea>

                    <h6>Add Video Url</h6>
                    <input name="url" type="text" placeholder="Add Video Url" class="form-control" />
