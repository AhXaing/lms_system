                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ !empty($profileData->photo) ? url('upload/user_profile/' . $profileData->photo) : url('upload/no-image.png') }}"
                            ...
                            <form action="{{ route('admin.profile.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage"
                                                src="{{ !empty($profileData->photo) ? url('upload/user_profile/' . $profileData->photo) : url('upload/no-image.png') }}"
